...
export default function GroupsPage() {
  ...
  async function handleCreate(e: FormEvent) {
    ...
    try {
      const created = await createGroup(accessToken, name, description || null);
  ...
  return (
    <div style={{ maxWidth: 640, margin: "0 auto", padding: "var(--sp-7) var(--sp-5)", display: "flex", flexDirection: "column", gap: "var(--sp-6)" }}>
      <div>
      ...
      <form onSubmit={handleCreate} className="card" style={{ display: "flex", flexDirection: "column", gap: "var(--sp-3)" }}>
